...
function panel_refresh(panel,action,callback){        
    if(!panel.hasClass("panel-refreshing")){
        panel.append('<div class="panel-refresh-layer"><img src="../static/cabinet/img/loaders/default.gif"/></div>');
...
function widget_refresh(widget,action,callback){
    if(!widget.hasClass("widget-refreshing")){
        widget.append('<div class="widget-refresh-layer"><img src="../static/cabinet/img/loaders/default.gif"/></div>');
